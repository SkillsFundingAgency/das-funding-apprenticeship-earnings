...
public static class ApprenticeshipEpisodeExtensions
{
    ...
    public static ApprenticeshipEarningsProfile CreateEarningsProfile(
    ...
    {
        return new ApprenticeshipEarningsProfile(onProgramTotal, instalments, additionalPayments, mathsAndEnglishCourses,
            completionPayment, episodeKey, isApproved, episode.AddChildToRoot, calculationData);
    }
    ...
    public static List<DeliveryPeriod> BuildDeliveryPeriods(this ApprenticeshipEpisode currentEpisode)
    {
        ...
        if (currentEpisode.EarningsProfile != null)
        {
            ...
            deliveryPeriods.AddRange(currentEpisode.EarningsProfile.MathsAndEnglishCourses.SelectMany(course => course.AdditionalPayments.Select(additionalPayment => new DeliveryPeriod(
                additionalPayment.DeliveryPeriod.ToCalendarMonth(),
                additionalPayment.AcademicYear.ToCalendarYear(additionalPayment.DeliveryPeriod),
                additionalPayment.DeliveryPeriod,
                additionalPayment.AcademicYear,
