...
namespace SFA.DAS.Funding.ApprenticeshipEarnings.Queries.UnitTests.GetAcademicYearEarnings
{
    public class WhenGetAcademicYearEarnings
    {
        ...
        public void Setup()
        {
            ...
            _sut = new GetAcademicYearEarningsQueryHandler(_earningsQueryRepository.Object, _academicYearService.Object);
        }
        ...
        public async Task ThAcademicYearEarningsAreReturned()
        {
            ...
            _earningsQueryRepository.Setup(x => x.GetAcademicYearEarnings(query.Ukprn, currentAcademicYear)).ReturnsAsync(expectedResult);
