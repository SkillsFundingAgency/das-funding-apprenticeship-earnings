...
Scenario: Approved short course with both milestones
...
Scenario: Approved short course with both milestones & completion date
	Given a short course has been created with the following information
		| StartDate  | ExpectedEndDate | TotalPrice | Milestones                                      | CompletionDate |
		| 2021-01-01 | 2021-06-25      |       2000 | ThirtyPercentLearningComplete, LearningComplete | 2021-06-04     |
	And a LearningApproved event is received for the short course
	Then the payments event is sent to pv2 with the correct information
