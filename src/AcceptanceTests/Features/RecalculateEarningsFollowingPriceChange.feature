Feature: Recalculate earnings following the approval
...
#	And a price change request was sent before the end of R14 of the current academic year (year X)
...
#	Given earnings have been calculated for an apprenticeship in the pilot 
#	And a price change request was sent before the end of the current academic year i.e. before the end of R14 (year X) 
...
#	And the amount of each instalment is determined as:( [new price less completion] - [earnings before the effective-from date] ) / [number of instalments]