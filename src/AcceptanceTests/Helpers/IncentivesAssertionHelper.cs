...
{
    public static void AssertIncentivePayment(string type, bool second, bool expectedPayment, UpdateOnProgrammeRequest updateOnProgrammeRequest, LearningEntity apprenticeshipModel)
    {
